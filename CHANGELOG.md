...
## explorer 全量轨道（2026-07-19）

新增 0 · 移除 0 · 定义变更 81（全量共 1627 个接口）

### 定义变更
- `GET /open-apis/application/v6/applications/{app_id}/feedbacks`「获取应用反馈列表」（application/v6/application.feedback/list）
- `POST /open-apis/authen/v1/refresh_access_token`「刷新 user_access_token（v1 版本）」（authen/v1/refresh_access_token/create）
- `GET /open-apis/authen/v1/user_info`「获取用户信息」（authen/v1/user_info/get）
- `POST /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records/batch_create`「新增多条记录」（bitable/v1/app.table.record/batch_create）
- `POST /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records/batch_get`「批量获取记录」（bitable/v1/app.table.record/batch_get）
- `GET /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records/{record_id}`「检索记录」（bitable/v1/app.table.record/get）
- `GET /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records`「列出记录」（bitable/v1/app.table.record/list）
- `POST /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records/search`「查询记录」（bitable/v1/app.table.record/search）
- `PUT /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records/{record_id}`「更新记录」（bitable/v1/app.table.record/update）
- `GET /open-apis/calendar/v4/exchange_bindings/{exchange_binding_id}`「查询 Exchange 账户的绑定状态」（calendar/v4/exchange_binding/get）
- `POST /open-apis/compensation/v1/archives/query`「批量查询员工薪资档案」（compensation/v1/archive/query）
...
- `GET /open-apis/contact/v3/departments/batch`「批量获取部门信息」（contact/v3/department/batch）
- `GET /open-apis/contact/v3/departments/{department_id}/children`「获取子部门列表」（contact/v3/department/children）
- `POST /open-apis/contact/v3/departments`「创建部门」（contact/v3/department/create）
- `GET /open-apis/contact/v3/departments/{department_id}`「获取单个部门信息」（contact/v3/department/get）
- `GET /open-apis/contact/v3/departments`「获取部门信息列表」（contact/v3/department/list）
- `GET /open-apis/contact/v3/departments/parent`「获取父部门信息」（contact/v3/department/parent）
- `POST /open-apis/contact/v3/departments/search`「搜索部门」（contact/v3/department/search）
- `PUT /open-apis/contact/v3/departments/{department_id}`「更新部门所有信息」（contact/v3/department/update）
- `GET /open-apis/contact/v3/users/batch`「批量获取用户信息」（contact/v3/user/batch）
- `POST /open-apis/contact/v3/users/batch_get_id`「通过手机号或邮箱获取用户 ID」（contact/v3/user/batch_get_id）
- `POST /open-apis/contact/v3/users`「创建用户」（contact/v3/user/create）
- `GET /open-apis/contact/v3/users/find_by_department`「获取部门直属用户列表」（contact/v3/user/find_by_department）
- `GET /open-apis/contact/v3/users/{user_id}`「获取单个用户信息」（contact/v3/user/get）
- `GET /open-apis/contact/v3/users`「获取用户列表」（contact/v3/user/list）
- `PATCH /open-apis/contact/v3/users/{user_id}`「修改用户部分信息」（contact/v3/user/patch）
- `PUT /open-apis/contact/v3/users/{user_id}`「更新用户所有信息」（contact/v3/user/update）
- `PATCH /open-apis/corehr/v1/employments/{employment_id}`「更新雇佣信息」（corehr/v1/employment/patch）
- `POST /open-apis/corehr/v1/job_changes`「发起员工异动(不推荐)」（corehr/v1/job_change/create）
...
- `POST /open-apis/corehr/v1/offboardings/search`「搜索离职信息」（corehr/v1/offboarding/search）
- `POST /open-apis/corehr/v2/approval_groups/open_query_department_change_list_by_ids`「批量查询部门调整内容」（corehr/v2/approval_groups/open_query_department_change_list_by_ids）
- `POST /open-apis/corehr/v2/approval_groups/open_query_job_change_list_by_ids`「批量查询人员调整内容」（corehr/v2/approval_groups/open_query_job_change_list_by_ids）
- `POST /open-apis/corehr/v2/contracts/search`「搜索合同」（corehr/v2/contract/search）
...
- `GET /open-apis/corehr/v2/custom_org/querybyid`「查询单个人员自定义组织变更记录」（corehr/v2/employee.custom_org/querybyid）
...
- `POST /open-apis/corehr/v2/employees/additional_jobs/batch`「批量查询兼职信息」（corehr/v2/employees.additional_job/batch）
- `POST /open-apis/corehr/v2/employees/additional_jobs`「创建兼职」（corehr/v2/employees.additional_job/create）
- `PATCH /open-apis/corehr/v2/employees/additional_jobs/{additional_job_id}`「更新兼职」（corehr/v2/employees.additional_job/patch）
- `POST /open-apis/corehr/v2/employees/international_assignments`「创建外派信息」（corehr/v2/employees.international_assignment/create）
- `GET /open-apis/corehr/v2/employees/international_assignments`「批量查询外派信息」（corehr/v2/employees.international_assignment/list）
- `PATCH /open-apis/corehr/v2/employees/international_assignments/{international_assignment_id}`「更新外派信息」（corehr/v2/employees.international_assignment/patch）
- `POST /open-apis/corehr/v2/employees/job_datas/batch_get`「批量查询员工任职信息」（corehr/v2/employees.job_data/batch_get）
- `POST /open-apis/corehr/v2/employees/job_datas/query`「获取任职信息列表」（corehr/v2/employees.job_data/query）
- `POST /open-apis/corehr/v2/job_changes`「发起员工异动」（corehr/v2/job_change/create）
- `POST /open-apis/corehr/v2/job_changes/search`「搜索员工异动信息」（corehr/v2/job_change/search）
...
- `POST /open-apis/corehr/v2/probation/search`「搜索试用期信息」（corehr/v2/probation/search）
- `POST /open-apis/corehr/v2/probation/submit`「发起转正」（corehr/v2/probation/submit）
- `POST /open-apis/directory/v1/departments/filter`「获取部门列表」（directory/v1/department/filter）
- `POST /open-apis/directory/v1/departments/mget`「批量获取部门信息」（directory/v1/department/mget）
- `POST /open-apis/directory/v1/departments/search`「搜索部门」（directory/v1/department/search）
- `POST /open-apis/directory/v1/employees/filter`「批量获取员工列表」（directory/v1/employee/filter）
- `POST /open-apis/directory/v1/employees/mget`「批量获取员工信息」（directory/v1/employee/mget）
- `POST /open-apis/directory/v1/employees/search`「搜索员工信息」（directory/v1/employee/search）
...
- `POST /open-apis/hire/v1/agencies/get_agency_account`「查询猎头供应商下猎头列表」（hire/v1/agency/get_agency_account）
- `GET /open-apis/hire/v1/applications/{application_id}/get_detail`「获取投递详情」（hire/v1/application/get_detail）
- `POST /open-apis/hire/v1/background_check_orders/batch_query`「查询背调信息列表」（hire/v1/background_check_order/batch_query）
- `GET /open-apis/hire/v1/referral_account/get_account_assets`「查询内推账户」（hire/v1/referral_account/get_account_assets）
- `GET /open-apis/hire/v2/talents/{talent_id}`「获取人才详情」（hire/v2/talent/get）
...
- `POST /open-apis/performance/v2/user_info/query`「获取绩效周期的人员信息」（performance/v2/user_info/query）

## explorer 全量轨道（2026-07-19）

新增 0 · 移除 0 · 定义变更 79（全量共 1627 个接口）

### 定义变更
- `GET /open-apis/application/v6/applications/{app_id}/feedbacks`「获取应用反馈列表」（application/v6/application.feedback/list）
- `POST /open-apis/authen/v1/access_token`「获取 user_access_token（v1 版本）」（authen/v1/access_token/create）
- `GET /open-apis/authen/v1/user_info`「获取用户信息」（authen/v1/user_info/get）
- `POST /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records/batch_create`「新增多条记录」（bitable/v1/app.table.record/batch_create）
- `POST /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records/batch_get`「批量获取记录」（bitable/v1/app.table.record/batch_get）
- `POST /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records/batch_update`「更新多条记录」（bitable/v1/app.table.record/batch_update）
- `POST /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records`「新增记录」（bitable/v1/app.table.record/create）
- `GET /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records/{record_id}`「检索记录」（bitable/v1/app.table.record/get）
- `GET /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records`「列出记录」（bitable/v1/app.table.record/list）
- `POST /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records/search`「查询记录」（bitable/v1/app.table.record/search）
- `PUT /open-apis/bitable/v1/apps/{app_token}/tables/{table_id}/records/{record_id}`「更新记录」（bitable/v1/app.table.record/update）
...
- `GET /open-apis/contact/v3/departments`「获取部门信息列表」（contact/v3/department/list）
- `GET /open-apis/contact/v3/departments/parent`「获取父部门信息」（contact/v3/department/parent）
- `PATCH /open-apis/contact/v3/departments/{department_id}`「修改部门部分信息」（contact/v3/department/patch）
- `PUT /open-apis/contact/v3/departments/{department_id}`「更新部门所有信息」（contact/v3/department/update）
- `GET /open-apis/contact/v3/users/batch`「批量获取用户信息」（contact/v3/user/batch）
- `POST /open-apis/contact/v3/users/batch_get_id`「通过手机号或邮箱获取用户 ID」（contact/v3/user/batch_get_id）
- `POST /open-apis/contact/v3/users`「创建用户」（contact/v3/user/create）
...
- `POST /open-apis/corehr/v1/offboardings/search`「搜索离职信息」（corehr/v1/offboarding/search）
- `POST /open-apis/corehr/v2/approval_groups/open_query_job_change_list_by_ids`「批量查询人员调整内容」（corehr/v2/approval_groups/open_query_job_change_list_by_ids）
- `POST /open-apis/corehr/v2/approval_groups/open_query_position_change_list_by_ids`「批量查询岗位调整内容」（corehr/v2/approval_groups/open_query_position_change_list_by_ids）
- `POST /open-apis/corehr/v2/contracts/search`「搜索合同」（corehr/v2/contract/search）
- `POST /open-apis/corehr/v2/departments/batch_get`「批量查询部门」（corehr/v2/department/batch_get）
- `POST /open-apis/corehr/v2/departments/query_timeline`「查询指定生效日期的部门基本信息」（corehr/v2/department/query_timeline）
- `POST /open-apis/corehr/v2/departments/search`「搜索部门信息」（corehr/v2/department/search）
...
- `POST /open-apis/corehr/v2/employees/job_datas/batch_get`「批量查询员工任职信息」（corehr/v2/employees.job_data/batch_get）
- `POST /open-apis/corehr/v2/employees/job_datas/query`「获取任职信息列表」（corehr/v2/employees.job_data/query）
- `POST /open-apis/corehr/v2/jobs/batch_get`「根据条件批量获取职务」（corehr/v2/job/batch_get）
- `POST /open-apis/corehr/v2/job_changes`「发起员工异动」（corehr/v2/job_change/create）
- `POST /open-apis/corehr/v2/job_changes/search`「搜索员工异动信息」（corehr/v2/job_change/search）
- `POST /open-apis/corehr/v2/persons`「创建个人信息」（corehr/v2/person/create）
- `PATCH /open-apis/corehr/v2/persons/{person_id}`「更新个人信息」（corehr/v2/person/patch）
...
- `GET /open-apis/drive/v1/permissions/{token}/members`「获取云文档协作者」（drive/v1/permission.member/list）
- `GET /open-apis/drive/v2/files/{file_token}/likes`「获取云文档的点赞者列表」（drive/v2/file.like/list）
- `POST /open-apis/hire/v1/agencies/batch_query`「搜索猎头供应商列表」（hire/v1/agency/batch_query）
- `GET /open-apis/hire/v1/applications/{application_id}`「获取投递信息」（hire/v1/application/get）
- `GET /open-apis/hire/v1/applications/{application_id}/get_detail`「获取投递详情」（hire/v1/application/get_detail）
- `POST /open-apis/hire/v1/background_check_orders/batch_query`「查询背调信息列表」（hire/v1/background_check_order/batch_query）
- `GET /open-apis/hire/v1/offers/{offer_id}`「获取 Offer 详情」（hire/v1/offer/get）
- `GET /open-apis/hire/v1/referral_account/get_account_assets`「查询内推账户」（hire/v1/referral_account/get_account_assets）
- `GET /open-apis/hire/v2/talents/{talent_id}`「获取人才详情」（hire/v2/talent/get）
- `GET /open-apis/mail/v1/public_mailboxes`「查询所有公共邮箱」（mail/v1/public_mailbox/list）
- `GET /open-apis/mail/v1/user_mailboxes/{user_mailbox_id}/messages/{message_id}`「获取邮件详情」（mail/v1/user_mailbox.message/get）
- `GET /open-apis/mail/v1/user_mailboxes/{user_mailbox_id}/threads/{thread_id}`「获取邮件会话详情」（mail/v1/user_mailbox.thread/get）
- `POST /open-apis/performance/v2/user_info/query`「获取绩效周期的人员信息」（performance/v2/user_info/query）
